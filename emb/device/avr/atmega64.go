...
const (
	...
	EXTENDED_CompMode_Msk = 0x2 // ATmega103 Compatibility Mode
...
const (
	...
	XDIV_XDIV_Msk   = 0x7f // XTAl Divide Select Bits
)
...
// Bitfields for TC0: Timer/Counter, 8-bit Async
const (
...
// Bitfields for TC2: Timer/Counter, 8-bit
const (
