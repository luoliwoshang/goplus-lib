...
const (
	...
	LCDDR08_SEG124_Msk = 0x1  // LCD memory bit segment
	LCDDR08_SEG125     = 0x2  // LCD memory bit segment
	LCDDR08_SEG125_Msk = 0x2  // LCD memory bit segment
	LCDDR08_SEG126     = 0x4  // LCD memory bit segment
	LCDDR08_SEG126_Msk = 0x4  // LCD memory bit segment
	LCDDR08_SEG127     = 0x8  // LCD memory bit segment
	LCDDR08_SEG127_Msk = 0x8  // LCD memory bit segment
	LCDDR08_SEG128     = 0x10 // LCD memory bit segment
	LCDDR08_SEG128_Msk = 0x10 // LCD memory bit segment
	LCDDR08_SEG129     = 0x20 // LCD memory bit segment
	LCDDR08_SEG129_Msk = 0x20 // LCD memory bit segment
	LCDDR08_SEG130     = 0x40 // LCD memory bit segment
	LCDDR08_SEG130_Msk = 0x40 // LCD memory bit segment
	LCDDR08_SEG131     = 0x80 // LCD memory bit segment
	LCDDR08_SEG131_Msk = 0x80 // LCD memory bit segment

	// LCDDR07: LCD Data Register 7
	LCDDR07_SEG116     = 0x1  // LCD memory bit segment
	LCDDR07_SEG116_Msk = 0x1  // LCD memory bit segment
	LCDDR07_SEG117     = 0x2  // LCD memory bit segment
	LCDDR07_SEG117_Msk = 0x2  // LCD memory bit segment
	LCDDR07_SEG118     = 0x4  // LCD memory bit segment
	LCDDR07_SEG118_Msk = 0x4  // LCD memory bit segment
	LCDDR07_SEG119     = 0x8  // LCD memory bit segment
	LCDDR07_SEG119_Msk = 0x8  // LCD memory bit segment
	LCDDR07_SEG120     = 0x10 // LCD memory bit segment
	LCDDR07_SEG120_Msk = 0x10 // LCD memory bit segment
	LCDDR07_SEG121     = 0x20 // LCD memory bit segment
	LCDDR07_SEG121_Msk = 0x20 // LCD memory bit segment
	LCDDR07_SEG122     = 0x40 // LCD memory bit segment
	LCDDR07_SEG122_Msk = 0x40 // LCD memory bit segment
	LCDDR07_SEG123     = 0x80 // LCD memory bit segment
	LCDDR07_SEG123_Msk = 0x80 // LCD memory bit segment

	// LCDDR06: LCD Data Register 6
	LCDDR06_SEG108     = 0x1  // LCD memory bit segment
	LCDDR06_SEG108_Msk = 0x1  // LCD memory bit segment
	LCDDR06_SEG109     = 0x2  // LCD memory bit segment
	LCDDR06_SEG109_Msk = 0x2  // LCD memory bit segment
	LCDDR06_SEG110     = 0x4  // LCD memory bit segment
	LCDDR06_SEG110_Msk = 0x4  // LCD memory bit segment
	LCDDR06_SEG111     = 0x8  // LCD memory bit segment
	LCDDR06_SEG111_Msk = 0x8  // LCD memory bit segment
	LCDDR06_SEG112     = 0x10 // LCD memory bit segment
	LCDDR06_SEG112_Msk = 0x10 // LCD memory bit segment
	LCDDR06_SEG113     = 0x20 // LCD memory bit segment
	LCDDR06_SEG113_Msk = 0x20 // LCD memory bit segment
	LCDDR06_SEG114     = 0x40 // LCD memory bit segment
	LCDDR06_SEG114_Msk = 0x40 // LCD memory bit segment
	LCDDR06_SEG115     = 0x80 // LCD memory bit segment
	LCDDR06_SEG115_Msk = 0x80 // LCD memory bit segment

	// LCDDR05: LCD Data Register 5
	LCDDR05_SEG100     = 0x1  // LCD memory bit segment
	LCDDR05_SEG100_Msk = 0x1  // LCD memory bit segment
	LCDDR05_SEG101     = 0x2  // LCD memory bit segment
	LCDDR05_SEG101_Msk = 0x2  // LCD memory bit segment
	LCDDR05_SEG102     = 0x4  // LCD memory bit segment
	LCDDR05_SEG102_Msk = 0x4  // LCD memory bit segment
	LCDDR05_SEG103     = 0x8  // LCD memory bit segment
	LCDDR05_SEG103_Msk = 0x8  // LCD memory bit segment
	LCDDR05_SEG104     = 0x10 // LCD memory bit segment
	LCDDR05_SEG104_Msk = 0x10 // LCD memory bit segment
	LCDDR05_SEG105     = 0x20 // LCD memory bit segment
	LCDDR05_SEG105_Msk = 0x20 // LCD memory bit segment
	LCDDR05_SEG106     = 0x40 // LCD memory bit segment
	LCDDR05_SEG106_Msk = 0x40 // LCD memory bit segment
	LCDDR05_SEG107     = 0x80 // LCD memory bit segment
	LCDDR05_SEG107_Msk = 0x80 // LCD memory bit segment

	// LCDDR03: LCD Data Register 3
	LCDDR03_SEG024     = 0x1  // LCD memory bit segment
	LCDDR03_SEG024_Msk = 0x1  // LCD memory bit segment
	LCDDR03_SEG025     = 0x2  // LCD memory bit segment
	LCDDR03_SEG025_Msk = 0x2  // LCD memory bit segment
	LCDDR03_SEG026     = 0x4  // LCD memory bit segment
	LCDDR03_SEG026_Msk = 0x4  // LCD memory bit segment
	LCDDR03_SEG027     = 0x8  // LCD memory bit segment
	LCDDR03_SEG027_Msk = 0x8  // LCD memory bit segment
	LCDDR03_SEG028     = 0x10 // LCD memory bit segment
	LCDDR03_SEG028_Msk = 0x10 // LCD memory bit segment
	LCDDR03_SEG029     = 0x20 // LCD memory bit segment
	LCDDR03_SEG029_Msk = 0x20 // LCD memory bit segment
	LCDDR03_SEG030     = 0x40 // LCD memory bit segment
	LCDDR03_SEG030_Msk = 0x40 // LCD memory bit segment
	LCDDR03_SEG031     = 0x80 // LCD memory bit segment
	LCDDR03_SEG031_Msk = 0x80 // LCD memory bit segment

	// LCDDR02: LCD Data Register 2
	LCDDR02_SEG016     = 0x1  // LCD memory bit segment
	LCDDR02_SEG016_Msk = 0x1  // LCD memory bit segment
	LCDDR02_SEG017     = 0x2  // LCD memory bit segment
	LCDDR02_SEG017_Msk = 0x2  // LCD memory bit segment
	LCDDR02_SEG018     = 0x4  // LCD memory bit segment
	LCDDR02_SEG018_Msk = 0x4  // LCD memory bit segment
	LCDDR02_SEG019     = 0x8  // LCD memory bit segment
	LCDDR02_SEG019_Msk = 0x8  // LCD memory bit segment
	LCDDR02_SEG020     = 0x10 // LCD memory bit segment
	LCDDR02_SEG020_Msk = 0x10 // LCD memory bit segment
	LCDDR02_SEG021     = 0x20 // LCD memory bit segment
	LCDDR02_SEG021_Msk = 0x20 // LCD memory bit segment
	LCDDR02_SEG022     = 0x40 // LCD memory bit segment
	LCDDR02_SEG022_Msk = 0x40 // LCD memory bit segment
	LCDDR02_SEG023     = 0x80 // LCD memory bit segment
	LCDDR02_SEG023_Msk = 0x80 // LCD memory bit segment

	// LCDDR01: LCD Data Register 1
	LCDDR01_SEG008     = 0x1  // LCD memory bit segment
	LCDDR01_SEG008_Msk = 0x1  // LCD memory bit segment
	LCDDR01_SEG009     = 0x2  // LCD memory bit segment
	LCDDR01_SEG009_Msk = 0x2  // LCD memory bit segment
	LCDDR01_SEG010     = 0x4  // LCD memory bit segment
	LCDDR01_SEG010_Msk = 0x4  // LCD memory bit segment
	LCDDR01_SEG011     = 0x8  // LCD memory bit segment
	LCDDR01_SEG011_Msk = 0x8  // LCD memory bit segment
	LCDDR01_SEG012     = 0x10 // LCD memory bit segment
	LCDDR01_SEG012_Msk = 0x10 // LCD memory bit segment
	LCDDR01_SEG013     = 0x20 // LCD memory bit segment
	LCDDR01_SEG013_Msk = 0x20 // LCD memory bit segment
	LCDDR01_SEG014     = 0x40 // LCD memory bit segment
	LCDDR01_SEG014_Msk = 0x40 // LCD memory bit segment
	LCDDR01_SEG015     = 0x80 // LCD memory bit segment
	LCDDR01_SEG015_Msk = 0x80 // LCD memory bit segment

	// LCDDR00: LCD Data Register 0
	LCDDR00_SEG000     = 0x1  // LCD memory bit segment
	LCDDR00_SEG000_Msk = 0x1  // LCD memory bit segment
	LCDDR00_SEG001     = 0x2  // LCD memory bit segment
	LCDDR00_SEG001_Msk = 0x2  // LCD memory bit segment
	LCDDR00_SEG002     = 0x4  // LCD memory bit segment
	LCDDR00_SEG002_Msk = 0x4  // LCD memory bit segment
	LCDDR00_SEG003     = 0x8  // LCD memory bit segment
	LCDDR00_SEG003_Msk = 0x8  // LCD memory bit segment
	LCDDR00_SEG004     = 0x10 // LCD memory bit segment
	LCDDR00_SEG004_Msk = 0x10 // LCD memory bit segment
	LCDDR00_SEG005     = 0x20 // LCD memory bit segment
	LCDDR00_SEG005_Msk = 0x20 // LCD memory bit segment
	LCDDR00_SEG006     = 0x40 // LCD memory bit segment
	LCDDR00_SEG006_Msk = 0x40 // LCD memory bit segment
	LCDDR00_SEG007     = 0x80 // LCD memory bit segment
	LCDDR00_SEG007_Msk = 0x80 // LCD memory bit segment
	...
	LCDCCR_LCDDC_Msk  = 0xe0 // LCD Display Configuration
...
const (
	...
	PCMSK1_PCINT_Msk = 0xff // Pin Change Mask
	...
	PCMSK0_PCINT_Msk = 0xff // Pin Change Mask
)
