...
const (
	...
	EIMSK_INT_Msk = 0xf // External Interrupt Request Enable
...
// Bitfields for PSC1: Power Stage Controller
const (
	// PFRC1B: PSC 1 Input B Control
	PFRC1B_PCAE1B      = 0x80 // PSC 1 Capture Enable Input Part B
	PFRC1B_PCAE1B_Msk  = 0x80 // PSC 1 Capture Enable Input Part B
	PFRC1B_PISEL1B     = 0x40 // PSC 1 Input Select for Part B
	PFRC1B_PISEL1B_Msk = 0x40 // PSC 1 Input Select for Part B
	PFRC1B_PELEV1B     = 0x20 // PSC 1 Edge Level Selector on Input Part B
	PFRC1B_PELEV1B_Msk = 0x20 // PSC 1 Edge Level Selector on Input Part B
	PFRC1B_PFLTE1B     = 0x10 // PSC 1 Filter Enable on Input Part B
	PFRC1B_PFLTE1B_Msk = 0x10 // PSC 1 Filter Enable on Input Part B
	...
	PFRC1B_PRFM1B_Msk  = 0xf  // PSC 1 Retrigger and Fault Mode for Part B

	// PFRC1A: PSC 1 Input B Control
	PFRC1A_PCAE1A      = 0x80 // PSC 1 Capture Enable Input Part A
	PFRC1A_PCAE1A_Msk  = 0x80 // PSC 1 Capture Enable Input Part A
	PFRC1A_PISEL1A     = 0x40 // PSC 1 Input Select for Part A
	PFRC1A_PISEL1A_Msk = 0x40 // PSC 1 Input Select for Part A
	PFRC1A_PELEV1A     = 0x20 // PSC 1 Edge Level Selector on Input Part A
	PFRC1A_PELEV1A_Msk = 0x20 // PSC 1 Edge Level Selector on Input Part A
	PFRC1A_PFLTE1A     = 0x10 // PSC 1 Filter Enable on Input Part A
	PFRC1A_PFLTE1A_Msk = 0x10 // PSC 1 Filter Enable on Input Part A
	...
	PSOC1_PSYNC1__Msk = 0x30 // Synchronization Out for ADC Selection
	PSOC1_POEN1B      = 0x4  // PSCOUT11 Output Enable
	PSOC1_POEN1B_Msk  = 0x4  // PSCOUT11 Output Enable
	PSOC1_POEN1A      = 0x1  // PSCOUT10 Output Enable
	PSOC1_POEN1A_Msk  = 0x1  // PSCOUT10 Output Enable

	// PIM1: PSC1 Interrupt Mask Register
	PIM1_PSEIE1     = 0x20 // PSC 1 Synchro Error Interrupt Enable
	PIM1_PSEIE1_Msk = 0x20 // PSC 1 Synchro Error Interrupt Enable
	PIM1_PEVE1B     = 0x10 // External Event B Interrupt Enable
	PIM1_PEVE1B_Msk = 0x10 // External Event B Interrupt Enable
	PIM1_PEVE1A     = 0x8  // External Event A Interrupt Enable
	PIM1_PEVE1A_Msk = 0x8  // External Event A Interrupt Enable
	PIM1_PEOPE1     = 0x1  // End of Cycle Interrupt Enable
	PIM1_PEOPE1_Msk = 0x1  // End of Cycle Interrupt Enable

	// PIFR1: PSC1 Interrupt Flag Register
	PIFR1_POAC1B     = 0x80 // PSC 1 Output B Activity
	PIFR1_POAC1B_Msk = 0x80 // PSC 1 Output B Activity
	PIFR1_POAC1A     = 0x40 // PSC 1 Output A Activity
	PIFR1_POAC1A_Msk = 0x40 // PSC 1 Output A Activity
	PIFR1_PSEI1      = 0x20 // PSC 1 Synchro Error Interrupt
	PIFR1_PSEI1_Msk  = 0x20 // PSC 1 Synchro Error Interrupt
	PIFR1_PEV1B      = 0x10 // External Event B Interrupt
	PIFR1_PEV1B_Msk  = 0x10 // External Event B Interrupt
	PIFR1_PEV1A      = 0x8  // External Event A Interrupt
	PIFR1_PEV1A_Msk  = 0x8  // External Event A Interrupt
	PIFR1_PRN10      = 0x2  // Ramp Number
	PIFR1_PRN11      = 0x4  // Ramp Number
	PIFR1_PRN1_Msk   = 0x6  // Ramp Number
	PIFR1_PEOP1      = 0x1  // End of PSC1 Interrupt
	PIFR1_PEOP1_Msk  = 0x1  // End of PSC1 Interrupt
)
